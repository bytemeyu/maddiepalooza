...
export const stageController = {
  ...
  createStage: async (req, res) => {
    ...
    try {
      ...
      console.error(
        `Erro ao criar novo palco no banco de dados: ${err.message}`
      );
      res.status(500).json({
        success: false,
  ...
  updateStage: async (req, res) => {
    ...
    try {
      ...
      console.error(
        `Erro ao atualizar palco com id ${id} no banco de dados: ${err.message}`
      );
      res.status(500).json({
        success: false,
  ...
  deleteStage: async (req, res) => {
    ...
    try {
      ...
      console.error(
        `Erro ao deletar palco com id ${id} no banco de dados: ${err.message}`
      );
      res.status(500).json({
        success: false,
