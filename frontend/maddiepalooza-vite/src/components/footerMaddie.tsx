...
import { FooterMaddieProps } from "../types/footerMaddie";
...
export const FooterMaddie = ({ isAuthenticated = false, className, children, ...rest }: FooterMaddieProps) => {
    return (
        <>
            <Footer className="" liClassName="font-beiruti-english text-amber-50" pClassName="font-beiruti-english text-lg text-amber-50" companyName='bytemeyu' currentYear='2024'>
                ...
                <Link 
                    ...
                    className={` ${isAuthenticated ? "pointer-events-none cursor-default" : ""}`}
                >
                    <span className="text-xl">Política de privacidade</span>
                </Link>
                <Link 
                    to="/contact"
                    className={` ${isAuthenticated ? "pointer-events-none cursor-default" : ""}`}
