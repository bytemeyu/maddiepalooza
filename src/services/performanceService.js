...
export const performanceService = {
    ...
    createPerformance: async(artist_id, stage_id, start_time, end_time, date) => {
        try {
            return await performanceRepository.createPerformance(artist_id, stage_id, start_time, end_time, date);
        } catch(err) {
    ...
    updatePerformance: async(id, artist_id, stage_id, start_time, end_time, date) => {
        try {
            return await performanceRepository.updatePerformance(id, artist_id, stage_id, start_time, end_time, date);
        } catch(err) {
